...
function GenelDatalar() {
    ...
    $("#Birinci_Chart").html("<span id='cs-1' data-provide='circular' data-fill-color='" + PartiRenkler[TurkiyeVeri[0].No][1] + "' data-value='" + OyOran + "' data-radius='30' data-percent='true' data-thickness='10'></span>");
    ...
    OyOran = (OyOran >= 100) ? 100 : OyOran;
    OyOran = (JsonVeriGenel.AA.TurkiyeGeneli.Sandik.GecerliOy == "0") ? "0" : OyOran;
    $("#Ikinci_Chart").html("<span id='cs-1' data-provide='circular' data-fill-color='" + PartiRenkler[TurkiyeVeri[1].No][1] + "' data-value='" + OyOran + "' data-radius='30' data-percent='true' data-thickness='10'></span>");
    ...
    OyOran = (OyOran >= 100) ? 100 : OyOran;
    OyOran = (JsonVeriGenel.AA.TurkiyeGeneli.Sandik.GecerliOy == "0") ? "0" : OyOran;
    $("#Ucuncu_Chart").html("<span id='cs-1' data-provide='circular' data-fill-color='" + PartiRenkler[TurkiyeVeri[2].No][1] + "' data-value='" + OyOran + "' data-radius='30' data-percent='true' data-thickness='10'></span>");
    ...
    OyOran = (OyOran >= 100) ? 100 : OyOran;
    OyOran = (JsonVeriGenel.AA.TurkiyeGeneli.Sandik.GecerliOy == "0") ? "0" : OyOran;
    $("#Dorduncu_Chart").html("<span id='cs-1' data-provide='circular' data-fill-color='" + PartiRenkler[TurkiyeVeri[3].No][1] + "' data-value='" + OyOran + "' data-radius='30' data-percent='true' data-thickness='10'></span>");
...
function LineChart() {
    ...
    var Birinci_2002, Ikinci_2002, Ucuncu_2002, Dorduncu_2002;
    var Birinci_2007, Ikinci_2007, Ucuncu_2007, Dorduncu_2007;
    var Birinci_2011, Ikinci_2011, Ucuncu_2011, Dorduncu_2011;
    var Birinci_2015, Ikinci_2015, Ucuncu_2015, Dorduncu_2015;
    ...
    if (SecimSeviye == "1") { // il
        ...
        $.each(JsonVeriIl.Il.Ilce, function (a, b) {
            ...
            if (b.Kod == SeciliIlce) {
                ...
                $("#AcilanSandikLokasyon").attr("data-value", AcilanSandikOran);
